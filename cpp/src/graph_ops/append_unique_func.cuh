  ...
  cudaStream_t stream)
{
  ...
  wholememory_dtype_t node_wholememory_dtype = WHOLEMEMORY_DT_INT;
  if (sizeof(KeyT) == 8) { node_wholememory_dtype = WHOLEMEMORY_DT_INT64; }

  KeyT* output_unique_node_ptr = (KeyT*)gen_output_unique_node_buffer_mh.device_malloc(unique_neighbor_count + target_count, node_wholememory_dtype);
