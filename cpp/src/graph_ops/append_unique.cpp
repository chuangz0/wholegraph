...
wholememory_error_code_t graph_append_unique(wholememory_tensor_t target_nodes_tensor,
  ...
  if (output_neighbor_raw_to_unique_mapping_tensor_description.dim != 1 && output_neighbor_raw_to_unique_mapping_tensor_description.dim != 0 ) {
    WHOLEMEMORY_ERROR("output_neighbor_raw_to_unique_mapping_tensor should be 1D tensor or None.");
    return WHOLEMEMORY_INVALID_INPUT;
  }
  if (output_neighbor_raw_to_unique_mapping_tensor_description.dim == 1 && output_neighbor_raw_to_unique_mapping_tensor_description.dtype != WHOLEMEMORY_DT_INT) {
  ...
  return graph_ops::graph_append_unique(target_nodes_ptr,
