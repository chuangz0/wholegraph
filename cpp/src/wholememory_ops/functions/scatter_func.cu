...
wholememory_error_code_t scatter_floating_int32_func(const void *input,
                                                     ...
                                                     wholememory_matrix_description_t embedding_desc,
                                                     cudaStream_t stream);
wholememory_error_code_t scatter_floating_int64_func(const void *input,
                                                     wholememory_matrix_description_t input_desc,
                                                     void *indices,
                                                     wholememory_array_description_t indices_desc,
                                                     wholememory_gref_t embedding_gref,
...
wholememory_error_code_t scatter_func(const void *input,
  ...
  try {
    ...
    WHOLEMEMORY_EXPECTS(embedding_is_float == input_is_float,
    ...
    return p_scatter_func(input, input_desc, indices, indices_desc, embedding_gref, embedding_desc, stream);
