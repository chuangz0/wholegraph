 ...
 * @param indices_desc : indices array description, should have storage offset = 0, indice can be
 * int32 or int64
 * @param host_recv_rank_id_count_ptr : pointer to int64_t array of received id count from each
 * rank.
 * @param host_rank_id_count_ptr : pointer to int64_t array of id count to send to each rank.
 * @param host_rank_id_offset_ptr : pointer to int64_t array of offsets of id array to send to each
 * rank
