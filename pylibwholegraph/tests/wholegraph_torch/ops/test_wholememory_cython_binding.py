...
import torch
from pylibwholegraph.torch.wholegraph_env import get_stream, get_wholegraph_env_fns, wrap_torch_tensor, TorchMemoryContext
...
def test_smoke():
    ...
    ref_tensor = input_tensor.expand((output_len, embed_dim)) + indice_tensor.reshape((output_len, 1)).expand(
        (output_len, embed_dim))
    ...
    wmb.wholememory_env_test_cython_op(wrapped_input,
                                       wrapped_output,
